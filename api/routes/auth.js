...
router.get("/verify/:token", async (req, res) => {
  ...
  try {
    ...
    await user.save();
    res.redirect("http://localhost:5173/"); // Doğrulandıktan sonra yönlendirilecek sayfa
...
async function sendPasswordResetEmail(toEmail, token) {
  ...
  const mailOptionsReset = {
    ...
    text: `Şifrenizi sıfırlamak için lütfen aşağıdaki bağlantıya tıklayın: http://localhost:5173/reset-password/${token}`,
  };
